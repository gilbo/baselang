local F = {}
package.loaded["plexlang.src.functions"] = F
...
local TC = require 'plexlang.src.typechecker'
local CG = require 'plexlang.src.codegen'

local Stats = require 'plexlang.src.stats'
...
function F.compiletofile(objfile, headerfile, ftable)
  ...
  for key,func in pairs(ftable) do
    ...
    if not isfunction(func) then
      error('must supply Plexlang functions as table values: '..
            tostring(key), 2)
    end
